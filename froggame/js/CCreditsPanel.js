function CCreditsPanel(){
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oLinkOutline = new createjs.Text("www.frogtoken.net", "18px " + FONT_GAME, "#008733");
	...
	_oLinkOutline.x = CANVAS_WIDTH/2;
        ...
        _oLink = new createjs.Text("www.frogtoken.net", "18px " + FONT_GAME, "#fff");
    ...
    this._onLogoButRelease = function(){
        window.open("http://www.frogtoken.net/","_blank");
    };
